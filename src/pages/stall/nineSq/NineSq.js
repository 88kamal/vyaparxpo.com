...
//   const [selectedStall, setSelectedStall] = useState('9 Sq. Meter (3x3)');
...
//   // top total value
//   const brandingWithPerDay = (b1 * 1845);
...
//     const nineSquareMeterRef = collection(db, "nineSquareMeterPayment")
...
//         <input className=' text-xl text-center fonts1 text-white bg-pink-500' disabled type="text" name='6 Sq. Meter' value={selectedStall} onChange={(e) => setSelectedStall(e.target.value)} />
//       </div>
//       {/* {!paymentId ? */}
//       <div className="">
//         <div className="right">
//           <div className="inner">
//             <div className=" p-5 md:p-10 bg-pink-100 border border-gray-400 rounded-tl-3xl rounded-br-3xl rounded-lg ">
//               <form>
//                 <div className="grid gap-6 mb-6 md:grid-cols-2">
//                   <div>
//                     <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 ">Name *</label>
//                     <input type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} className="bg-pink-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5   " required />
//                   </div>
//                   <div>
//                     <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 ">Email *</label>
//                     <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} className="bg-pink-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5   " required />
//                   </div>
//                   <div>
//                     <label htmlFor="phone" className="block mb-2 text-sm font-medium text-gray-900 ">Mobile *</label>
//                     <input type="text" id="phone" value={phone} onChange={(e) => setPhone(e.target.value)} className="bg-pink-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5   " required />
//                   </div>
//                   <div>
//                     <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 ">Stall *</label>
//                     <input disabled type="number" value={stall} onChange={(e) => setStall(e.target.value)} id="email" className="bg-pink-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5   " required />
//                   </div>
//                   <div>
//                     <label htmlFor="branding" className="block mb-2 text-sm font-medium text-gray-900 ">Branding (Per day ₹1656)</label>
//                     <input type="number" value={branding} onChange={(e) => setBranding(e.target.value)} id="branding" className="bg-pink-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5   " required />
//                   </div>
//                   <div>
//                     <label htmlFor="digitalDisplay" className="block mb-2 text-sm font-medium text-gray-900 ">Digital Display (Per day ₹700)</label>
//                     <input type="number" value={digitalDisplay} onChange={(e) => setDigitalDisplay(e.target.value)} id="digitalDisplay" className="bg-pink-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5   " required />
//                   </div>
//                   <div>
...
//                     <input type="number" value={electricitySupply} onChange={(e) => setElectricitySupply(e.target.value)} id="electricitySupply" className="bg-pink-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5   " required />
//                   </div>
//                   <div>
//                     <label htmlFor="airCompressor" className="block mb-2 text-sm font-medium text-gray-900 ">Air Compressor (Per day ₹500) </label>
//                     <input type="number" value={airCompressor} onChange={(e) => setAirCompressor(e.target.value)} id="airCompressor" className="bg-pink-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5   " required />
//                   </div>
//                   <div className=' border border-pink-300 p-2'>
//                     {/* <hr className=' text-black' /> */}
//                     {/* <div className=' border border-black'></div> */}
//                     <h1><span className=' font-bold'>Total Without Gst :</span> ₹ {totalWithoutGst}</h1>
//                     <label htmlFor="airCompressor" className="block text-sm text-gray-900  font-semibold">Gst (18%) ₹13720.5</label>
...
//                     <input type="number" value={hotelAccomodation} onChange={(e) => setHotelAccomodation(e.target.value)} id="hotelAccomodation" className="bg-pink-50 border mb-2 border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5   " required />
...
//                     <input type="number" value={travel} onChange={(e) => setTravel(e.target.value)} id="travel" className="bg-pink-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5   " required />
//                   </div>
//                   <div>
//                     <label htmlFor="fooding" className="block mb-2 text-sm font-medium text-gray-900 ">Fooding
//                       (Enter Number Of staff)</label>
//                     <input type="number" value={fooding} onChange={(e) => setFooding(e.target.value)} id="fooding" className="bg-pink-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5  mb-5  " placeholder='Enter Number Of Staff Member' required />

//                   </div>
//                   <div className="">
//                     <label htmlFor="selectDay" className="block mb-2 text-sm font-medium text-gray-900 ">Enter Days For Food (₹350 per plate)</label>
//                     <input type="number" value={selectDay} onChange={handleSelectChangeOne} id="fooding" className="bg-pink-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-pink-600 focus:border-pink-600 block w-full p-2.5  mb-5  " required />
//                   </div>
//                 </div>
//                 <div>
//                   <div className=" border border-pink-300 mb-2"></div>
...
//                 <button onClick={pay} type="submit" className="text-white w-full bg-pink-500 hover:bg-blue-800 focus:ring-4 outline-0 focus:ring-blue-300 font-medium rounded-xl text-sm sm:w-auto px-10 py-2.5 text-center ">Pay Now</button>
//                 <ToastContainer />
//               </div>
//             </div>
//           </div>
