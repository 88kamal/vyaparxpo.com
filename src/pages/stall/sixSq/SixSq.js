...
function SixSq() {
  ...
  const [stall, setStall] = useState(3900);
  ...
  // top total value
  const brandingWithPerDay = (b1 * 1656);
  ...
  const pay = async () => {
    ...
    // console.log(electricitySupply);
    // console.log(airCompressor);
    // console.log(hotelAccomodation);
    // console.log(travel);
    // console.log(fooding);
...
console.log(pay)
    ...
    // database firbase
    const sixSquareMeterRef = collection(db, "sixSquareMeterPayment")
  ...
  return (
    <div>
      <div className=" text-center mb-5">
        <input className=' text-xl text-center fonts1 bg-purple-500 text-white ' disabled type="text" name='6 Sq. Meter' value={selectedStall} onChange={(e) => setSelectedStall(e.target.value)} />
      </div>
      {/* {!paymentId ? */}
      <div className="">
        <div className="right">
          <div className="inner">
            <div className=" p-5 md:p-10 bg-purple-100 border border-gray-400 rounded-tl-3xl rounded-br-3xl rounded-lg ">
              <form>
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                  <div>
                    <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 ">Name *</label>
                    <input type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} className="bg-purple-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5   " required />
                  </div>
                  <div>
                    <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 ">Email *</label>
                    <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} className="bg-purple-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5   " required />
                  </div>
                  <div>
                    <label htmlFor="phone" className="block mb-2 text-sm font-medium text-gray-900 ">Mobile *</label>
                    <input type="text" id="phone" value={phone} onChange={(e) => setPhone(e.target.value)} className="bg-purple-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5   " required />
                  </div>
                  <div>
                    <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 ">Stall *</label>
                    <input disabled type="number" value={stall} onChange={(e) => setStall(e.target.value)} id="email" className="bg-purple-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5   " required />
                  </div>
                  <div>
                    <label htmlFor="branding" className="block mb-2 text-sm font-medium text-gray-900 ">Branding (Per day ₹1656)</label>
                    <input type="number" value={branding} onChange={(e) => setBranding(e.target.value)} id="branding" className="bg-purple-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5   " required />
                  </div>
                  <div>
                    <label htmlFor="digitalDisplay" className="block mb-2 text-sm font-medium text-gray-900 ">Digital Display (Per day ₹700)</label>
                    <input type="number" value={digitalDisplay} onChange={(e) => setDigitalDisplay(e.target.value)} id="digitalDisplay" className="bg-purple-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5   " required />
                  </div>
                  <div>
                    ...
                    <input type="number" value={electricitySupply} onChange={(e) => setElectricitySupply(e.target.value)} id="electricitySupply" className="bg-purple-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5   " required />
                  </div>
                  <div>
                    <label htmlFor="airCompressor" className="block mb-2 text-sm font-medium text-gray-900 ">Air Compressor (Per day ₹500) </label>
                    <input type="number" value={airCompressor} onChange={(e) => setAirCompressor(e.target.value)} id="airCompressor" className="bg-purple-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5   " required />
                  </div>
                  <div className=' border border-purple-300 p-2'>
                    ...
                    <label htmlFor="airCompressor" className="block text-sm text-gray-900  font-semibold">Gst (18%) ₹ 10,040.4</label>
                ...
                <div className="grid gap-6 mb-3 md:grid-cols-2">
                  <div>
                    ...
                    <input type="number" value={hotelAccomodation} onChange={(e) => setHotelAccomodation(e.target.value)} id="hotelAccomodation" className="bg-purple-50 border mb-2 border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5   " required />
                  ...
                  <div>
                    ...
                    <input type="number" value={travel} onChange={(e) => setTravel(e.target.value)} id="travel" className="bg-purple-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5   " required />
                  </div>
                  <div>
                    <label htmlFor="fooding" className="block mb-2 text-sm font-medium text-gray-900 ">Fooding
                      (Enter Number Of staff)</label>
                    <input type="number" value={fooding} onChange={(e) => setFooding(e.target.value)} id="fooding" className="bg-purple-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5  mb-5  " placeholder='Enter Number Of Staff Member' required />

                  </div>
                  <div className="">
                    <label htmlFor="selectDay" className="block mb-2 text-sm font-medium text-gray-900 ">Enter Days For Food (₹350 per plate)</label>
                    <input type="number" value={selectDay} onChange={handleSelectChangeOne} id="fooding" className="bg-purple-50 border border-gray-300 text-gray-900 text-sm rounded-[6px] outline-0 focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5  mb-5  " required />
                  </div>
                </div>
                <div>
                  <div className=" border border-purple-300 mb-2"></div>
              ...
              <div className=" flex my-5">
                <button onClick={pay} type="submit" className="text-white w-full bg-purple-500 hover:bg-blue-800 focus:ring-4 outline-0 focus:ring-blue-300 font-medium rounded-xl text-sm sm:w-auto px-10 py-2.5 text-center ">Pay Now</button>
                <ToastContainer />
              </div>
            </div>
          </div>
