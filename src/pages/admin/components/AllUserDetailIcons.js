            ...
            <div className="container px-5 py-10 mx-auto">
                ...
                <div className="flex flex-wrap -m-4 text-center">
                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className="border-2  border-purple-500 px-4 py-3 rounded-xl" style={{background:'rgb(46, 50, 59)'}}>
                    ...
                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className="border-2  border-pink-500 px-4 py-3 rounded-xl" style={{background:'rgb(46, 50, 59)'}}>
                    ...
                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className="border-2  border-green-500 px-4 py-3 rounded-xl" style={{background:'rgb(46, 50, 59)'}}>
                    ...
                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className="border-2  border-orange-500 px-4 py-3 rounded-xl" style={{background:'rgb(46, 50, 59)'}}>
