...
function FifteenSqMeter({ fifteenSqMeter }) {
        ...
        <div>
            <div className=" h-[100em]" style={{ backgroundColor: 'rgb(32, 33, 36)' }}>
                ...
                <div className="container mx-auto px-4">
                    {/* {id} */}
                    <h1 className=' text-center text-2xl my-5 fonts2 font-bold underline text-white'>15 Sq Meter (3x5)Payment Detail</h1>
                    <div className="flex justify-between">
                        <Link to={'/admin/twelvesqmeter'}>
                            <button type="button" className="text-white bg-orange-700 hover:bg-blue-800 focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  mb-2 ">Go back to 12 Sq Meter</button></Link>
                            
                        <Link to={'/adminpanel'}>
                            <button type="button" className="text-white bg-orange-700 hover:bg-blue-800 focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  mb-2 "> Go to Admin Panel</button></Link>
                            ...
                            <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                <div className="overflow-hidden">
                                    <table className="min-w-full border text-sm font-light text-white border-neutral-500">
                                        <thead style={{ backgroundColor: 'rgb(40, 44, 52)' }} className="border-b font-medium bg-gray-900 dark:border-neutral-500">
                                            <tr>
