...
function NineSqMeter({ nineSqMeter }) {
        ...
        <div>
            <div className=" h-[100em]" style={{ backgroundColor: 'rgb(32, 33, 36)' }}>
                ...
                <div className="container mx-auto px-4">
                    {/* {id} */}
                    <h1 className=' text-center text-2xl my-5 fonts2 font-bold underline text-white'>9 Sq Meter (3x3) Payment Detail</h1>
                    <div className="flex justify-between">
                        <Link to={'/admin/sixsqmeter'}>
                            <button type="button" className="text-white bg-pink-700 hover:bg-blue-800 focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  mb-2 ">Go back to 6 Sq Meter</button></Link>
                            <Link to={'/adminpanel'}>
                            <button type="button" className="text-white bg-pink-700 hover:bg-blue-800 focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  mb-2 "> Go to Admin Panel</button></Link>
                        <Link to={'/admin/twelvesqmeter'}>
                            <button type="button" className="text-white bg-pink-700 hover:bg-blue-800 focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  mb-2 ">Go to 12 Sq Meter</button></Link>
