...
function SixSqMeter({ sixSqMeter }) {
        ...
        <div>
            <div className=" h-[100em]" style={{ backgroundColor: 'rgb(32, 33, 36)' }}>
                ...
                <div className="container mx-auto px-4">
                    {/* {id} */}
                    <h1 className=' text-center text-2xl my-5 fonts2 font-bold underline text-white'>6 Sq Meter (3x2) Payment Detail</h1>
                    <div className="flex justify-between">
                        <Link to={'/adminpanel'}>
                            <button type="button" className="text-white bg-purple-700 hover:bg-blue-800 focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  mb-2 ">Back</button></Link>
                        <Link to={'/admin/ninesqmeter'}>
                            <button type="button" className="text-white bg-purple-700 hover:bg-blue-800 focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  mb-2 ">Go to 9 Sq Meter</button></Link>
