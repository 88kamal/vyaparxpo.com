                ...
                <section className="text-gray-600 body-font">
                    <div className="container mx-auto flex px-5  md:flex-row flex-col items-center">
                        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-1 md:mb-0 items-center text-center">
                            ...
                            <p className="mb-8 leading-relaxed text-justify fonts">Promoting Food & Agriculture Processing Industries in Varanasi will uplift Varanasi business segment and structure keeping all the view of development Vyapar Xpo India is organizing Food&Agro Vyapar Expo 2023 for the first time in Varanasi.
                                Varanasi is the destination where people language, culture and commerce connect to create endless possibilities for business in all the category of Food & Agriculture.
                                After successful event of <b>TAMIL&KASHI SANGAMAM</b> in Kashi, Organized by our honorable Prime Minister <b>SRI NARENDRA MODI</b> Varanasi is the best platform & gateway to introduce new industries across the India. Technology knowledge from the manufacturer for the development of new product and introducing new product in market.
                                There are abundant investment opportunities in the Food & Agriculture processing sector after <br />
                                <h1 className=' font-bold'>UP GLOBAL INVESTOR SUMMIT 2023 in Uttar Pradesh</h1>
                                Vyapar India will help us to attract investment, increase employment opportunities and boost the rural economy.
