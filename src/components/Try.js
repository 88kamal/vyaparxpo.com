                    ...
                    <div className="justify-between px-4 mx-auto  lg:max-w-7xl md:items-center md:flex md:px-8   ">
                        <div>
                            <div className="flex items-center justify-between py-3 md:py-5 md:block">
                                <div>
                                    <img width={190} src="image/logo.png" alt="" />
                                </div>
                        ...
                        <div>
                            ...
                            >
                                <ul className="items-center justify-center space-y-4 md:flex md:space-x-6 md:space-y-0 p-5 md:p-0">
                                    <li className="text-gray-100 font-semibold text-sm hover:text-[#00ffc4] uppercase md:border border-white md:px-5 md:rounded-full hover:border-[#00ffc4]">
                                        <a className=' flex' href='/' > Home</a>
                                    </li>
                                    <li className="text-gray-100 font-semibold text-sm hover:text-[#00ffc4] uppercase ">
                                        <a href='/' className='md:hover:border-b-2 py-[1px] border-[#00ffc4] ' >About</a>
                                    </li>
                                    <li className="text-gray-600 font-semibold text-sm   ">

                                    <div className="dropdown inline-block  ">
                                            <button className=" text-gray-100 hover:text-[#00ffc4] font-semibold md:py-2  rounded inline-flex items-center">
                                                <span className="mr-1 md:hover:border-b-2 py-[1px] border-[#00ffc4] ">EXHIBITOR</span>
                                            ...
                                            <ul className="dropdown-menu absolute hidden text-gray-700 md:pt-5 border-b-2 border-red-600 ">
                                                <li className><a className=" bg-white text-sm font-medium  hover:text-red-600 hover:border-b border-red-600 py-2 px-4 block whitespace-no-wrap" href="#">why do Exhibit</a></li>
                                                <hr />
                                                ...
                                                <hr />
                                                <li className><a className=" bg-white text-sm font-medium  hover:text-red-600 hover:border-b border-red-600 py-2 px-4 block whitespace-no-wrap" href="#">Hotel Transportation</a></li>
                                                <hr />
                                    ...
                                    <li className="text-gray-100 font-semibold text-sm  ">
                                        ...
                                        <div className="dropdown inline-block  ">
                                            <button className=" text-gray-100 hover:text-[#00ffc4] font-semibold md:py-2  rounded inline-flex items-center">
                                                <span className="mr-1 md:hover:border-b-2 py-[1px] border-[#00ffc4] ">VISITOR</span>
                                                {/* <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" /> </svg> */}
                                            </button>
                                            <ul className="dropdown-menu absolute hidden text-gray-700 md:pt-5 border-b-2 border-red-600 ">
                                    ...
                                    <li className="text-gray-600 font-semibold text-sm hover:text-[#00ffc4] uppercase">
                                        <div className="dropdown inline-block  ">
                                            <button className=" text-gray-100 hover:text-[#00ffc4] font-semibold md:py-2  rounded inline-flex items-center">
                                                <span className="mr-1 md:hover:border-b-2 py-[1px] border-[#00ffc4] ">GLIMPSES</span>
                                                {/* <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" /> </svg> */}
                                            </button>
                                            <ul className="dropdown-menu absolute hidden text-gray-800 md:pt-5 border-b-2 border-red-600 ">
                                    ...
                                    <li className="text-gray-100 font-semibold text-sm hover:text-[#00ffc4] uppercase">
                                        <a href='/' className='md:hover:border-b-2 py-[1px] border-[#00ffc4] ' >CONTACT US</a>
                                    </li>
                                    <li className="text-gray-100 font-semibold text-sm hover:text-[#00ffc4] uppercase">
                                        <a href='/'  className='md:hover:border-b-2 py-[1px] border-[#00ffc4] '>EXHIBITOR LOGIN</a>
                                    </li>
