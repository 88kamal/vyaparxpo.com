                                ...
                                <ul className="items-center justify-center space-y-4 md:flex md:space-x-6 md:space-y-0 p-5 md:p-0">
                                    ...
                                    <li className="text-gray-600 font-semibold text-sm   ">
                                        ...
                                        <div className="dropdown inline-block  ">
                                            ...
                                            <ul className="dropdown-menu absolute hidden text-gray-700 md:pt-5 border-b-2 border-red-600 ">
                                                ...
                                                <hr />
                                                <li className><Link to={'/registrationfrom'} className=" bg-white text-sm font-medium  hover:text-red-600 hover:border-b border-red-600 py-2 px-4 block whitespace-no-wrap" >Registration Exibitor</Link></li>
                                                <hr />
                                    ...
                                    <li className="text-gray-100 font-semibold text-sm  ">
                                        ...
                                        <div className="dropdown inline-block  ">
                                            ...
                                            <ul className="dropdown-menu absolute hidden text-gray-700 md:pt-5 border-b-2 border-red-600 ">
                                            <li className><Link className=" bg-white text-sm font-medium  hover:text-red-600 hover:border-b border-red-600 py-2 px-4 block whitespace-no-wrap" to={'/whyvisit'}>Why Visit</Link></li>
                                    ...
                                    <li className="text-gray-100 font-semibold text-sm hover:text-[yellow] uppercase">
                                        <Link  to={'/registrationfrom'} className='md:hover:border-b-2 py-[1px] border-[yellow] ' >BOOK YOUR STAND</Link>
                                    </li>
                                    <li className="text-gray-100 font-semibold text-sm hover:text-[yellow] uppercase">
